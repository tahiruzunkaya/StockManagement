...
.navbar {
  .navbar-nav > a.btn.btn-icon.btn-sm, .btn-group-sm.navbar-nav > a.btn.btn-icon {
    height: 1.875rem;
    min-width: 1.875rem;
    width: 1.875rem;
  }
...
.navbar {
  .navbar-nav > a.btn.btn-icon.btn-sm .fa, .btn-group-sm.navbar-nav > a.btn.btn-icon .fa, .navbar-nav > a.btn.btn-icon.btn-sm .far, .btn-group-sm.navbar-nav > a.btn.btn-icon .far, .navbar-nav > a.btn.btn-icon.btn-sm .fas, .btn-group-sm.navbar-nav > a.btn.btn-icon .fas, .navbar-nav > a.btn.btn-icon.btn-sm .tim-icons, .btn-group-sm.navbar-nav > a.btn.btn-icon .tim-icons {
    font-size: 0.6875rem;
  }
}
...
.navbar {
  .navbar-nav > a.btn.btn-icon.btn-lg, .btn-group-lg.navbar-nav > a.btn.btn-icon {
    height: 3.6rem;
    min-width: 3.6rem;
    width: 3.6rem;
  }
...
.navbar {
  .navbar-nav > a.btn.btn-icon.btn-lg .fa, .btn-group-lg.navbar-nav > a.btn.btn-icon .fa, .navbar-nav > a.btn.btn-icon.btn-lg .far, .btn-group-lg.navbar-nav > a.btn.btn-icon .far, .navbar-nav > a.btn.btn-icon.btn-lg .fas, .btn-group-lg.navbar-nav > a.btn.btn-icon .fas, .navbar-nav > a.btn.btn-icon.btn-lg .tim-icons, .btn-group-lg.navbar-nav > a.btn.btn-icon .tim-icons {
    font-size: 1.325rem;
  }
}

.btn.btn-icon:not(.btn-footer) {
  .tim-icons, .fa, .far, .fas {
    position: absolute;
    font-size: 1em;
    top: 50%;
    left: 50%;
...
.btn-neutral {
  ...
  &:hover:not(.nav-link), &:focus:not(.nav-link) {
    box-shadow: none;
  }
  &.btn-simple {
    color: #ffffff;
...
.dropup .dropdown-menu.dropdown-black {
  &:after {
    color: #1d253b;
    z-index: 2;
  }
...
.form-control {
  ...
  &:focus {
    ...
    background-color: transparent;
    box-shadow: none;
    + .input-group-append .input-group-text, ~ .input-group-append .input-group-text, + .input-group-prepend .input-group-text, ~ .input-group-prepend .input-group-text {
...
.has-danger {
  ...
  .form-control:focus, .input-group-append .input-group-text:focus, .input-group-prepend .input-group-text:focus {
    background-color: transparent;
  }
  &.input-group-focus {
    .input-group-prepend .input-group-text:focus, .input-group-append .input-group-text:focus {
      background-color: transparent;
    }
  }
}
...
@media screen and (max-width: 991px) {
  .navbar {
    ...
    .dropdown {
      ...
      &.show .dropdown-menu:before, .dropdown-menu:before {
        display: none;
      }
    }
    .dropdown-menu .dropdown-item {
...
.form-check input {
  &[type="checkbox"]:disabled + .form-check-sign, &[type="radio"]:disabled + .form-check-sign {
    pointer-events: none;
  }
}
...
.fixed-plugin {
  ...
  .light-badge:hover, .dark-badge:hover {
    border: 1px solid #1d8cf8;
  }
  .light-badge {
    background: #ffffff;
  ...
  .dropdown-menu > {
    li {
      ...
      a.switch-trigger:hover, > a.switch-trigger:focus {
        background-color: transparent;
      }
      &:hover > a.img-holder, &:focus > a.img-holder {
...
.sidebar-wrapper ul li div {
  &.collapse ul li div {
    &.collapse ul li a, &.collapsing ul li a {
      margin-left: 25px;
    }
  }
  &.collapsing ul li div.collapse ul li a {
    margin-left: 25px;
  }
}
...
.sidebar, .off-canvas-sidebar {
  background: #5e72e4;
  background: -webkit-linear-gradient(0deg, #5e72e4 0%, #e14eca 100%);
  background: -o-linear-gradient(0deg, #5e72e4 0%, #e14eca 100%);
  background: -moz-linear-gradient(0deg, #5e72e4 0%, #e14eca 100%);
...
.sidebar .sidebar-wrapper {
  > .nav [data-toggle="collapse"] ~ div > ul > li > a span, .user .info [data-toggle="collapse"] ~ div > ul > li > a span {
    display: inline-block;
  }
}
...
.sidebar .sidebar-wrapper {
  > .nav [data-toggle="collapse"] ~ div > ul > li > a .sidebar-normal, .user .info [data-toggle="collapse"] ~ div > ul > li > a .sidebar-normal {
    margin: 0;
    position: relative;
...
.sidebar .sidebar-wrapper {
  > .nav [data-toggle="collapse"] ~ div > ul > li > a .sidebar-mini-icon, .user .info [data-toggle="collapse"] ~ div > ul > li > a .sidebar-mini-icon {
    text-transform: uppercase;
    width: 34px;
    margin-right: 10px;
    margin-left: 0px;
...
.sidebar .sidebar-wrapper {
  > .nav [data-toggle="collapse"] ~ div > ul > li > a i, .user .info [data-toggle="collapse"] ~ div > ul > li > a i {
    font-size: 17px;
    line-height: 20px;
    width: 26px;
  }
...
.sidebar .sidebar-wrapper [data-toggle="collapse"] ~ div > ul > li:hover > a {
  .sidebar-mini-icon, .sidebar-normal {
    color: #ffffff;
  }
}

.off-canvas-sidebar .sidebar-wrapper [data-toggle="collapse"] ~ div > ul > li:hover > a {
  .sidebar-mini-icon, .sidebar-normal {
    color: #ffffff;
  }
}
...
.sidebar .nav li {
  &:hover:not(.active) > a i, &:focus:not(.active) > a i {
    color: #ffffff;
  }
}
  ...
  .sidebar-mini {
    ...
    .sidebar {
      ...
      .sidebar-wrapper {
        ...
        .user .info {
          [data-toggle="collapse"] ~ div > ul > li > a .sidebar-normal, > a > span {
            -webkit-transform: translate3d(-25px, 0, 0);
            -moz-transform: translate3d(-25px, 0, 0);
            -o-transform: translate3d(-25px, 0, 0);
            -ms-transform: translate3d(-25px, 0, 0);
      ...
      &:hover {
        ...
        .sidebar-wrapper {
          width: 260px;
          > .nav {
            li > a p, [data-toggle="collapse"] ~ div > ul > li > a .sidebar-normal {
              -webkit-transform: translate3d(0px, 0, 0);
              -moz-transform: translate3d(0px, 0, 0);
              -o-transform: translate3d(0px, 0, 0);
              -ms-transform: translate3d(0px, 0, 0);
...
.card-collapse .card a[data-toggle="collapse"] {
  &[aria-expanded="true"] i, &.expanded i {
    filter: progid:DXImageTransform.Microsoft.BasicImage(rotation=2);
    -webkit-transform: rotate(180deg);
    -ms-transform: rotate(180deg);
    transform: rotate(180deg);
...
.bd-docs {
  ...
  .bd-example thead th, table thead th {
    color: rgba(255, 255, 255, 0.8);
  }
  .bd-example {
    h1, h2, h3, h4, h5, h6, .h1, .h2, .h3, .h4, .h5, .h6 {
  ...
  .bd-example .picker-switch .tim-icons, table .picker-switch .tim-icons {
    color: #e14eca;
  }
...
@media screen and (max-width: 576px) {
  ...
  .form-horizontal {
    .col-form-label, .label-on-right {
      text-align: inherit;
      padding-top: 0;
    }
    .col-form-label code, .label-on-right code {
      padding: 0 10px;
    }
  }
}
...
.rtl {
  ...
  .sidebar .nav p, .bootstrap-navbar .nav p {
    margin-right: 45px;
    text-align: right;
  }
  .sidebar .nav .caret, .bootstrap-navbar .nav .caret {
    left: 11px;
    right: auto;
  }
  .sidebar .logo a.logo-mini, .bootstrap-navbar .logo a.logo-mini {
    float: right;
    margin-right: 20px;
    margin-left: 10px;
  }
  .sidebar .logo .simple-text, .bootstrap-navbar .logo .simple-text {
    text-align: right;
  }
  .sidebar .sidebar-wrapper {
    .nav [data-toggle="collapse"] ~ div > ul > li > a .sidebar-mini-icon, .user .info [data-toggle="collapse"] ~ div > ul > li > a .sidebar-mini-icon {
...
.form-group.form-control-lg {
  .input-group-prepend .input-group-text + .form-control, .input-group-append .input-group-text + .form-control {
...
.input-group-btn {
  &:first-child > .dropdown-toggle, &:last-child > .btn:not(:last-child):not(.dropdown-toggle) {
    border-right: 0 none;
  }
}
...
.input-group-btn {
  &:last-child > .dropdown-toggle, &:first-child > .btn:not(:first-child) {
    border-left: 0 none;
  }
}
...
.white-content {
  ...
  .input-group-focus {
    .input-group-prepend .input-group-text, .input-group-append .input-group-text, .form-control {
      border-color: #e14eca;
    }
    &.no-border {
      .input-group-prepend .input-group-text, .input-group-append .input-group-text {
  ...
  .progress-container {
    .progress, &.progress.sm .progress {
      background: rgba(34, 42, 66, 0.1);
      box-shadow: 0 0 0 3px rgba(34, 42, 66, 0.1);
    }
    .progress .progress-value, &.progress.sm .progress .progress-value {
      color: #344675;
    }
    .progress-badge, &.progress.sm .progress-badge {
      color: #1d253b;
    }
  }
  .full-page {
